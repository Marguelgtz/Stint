...
Subcommands:
  ...
  onbox   run or resume the on-box Hermes coordinator`,
		...
		flags: []cliFlag{
			...
			{name: "--runtime", argument: "<auto|ninfer|llama.cpp>", purpose: "new-session runtime forwarded to the standard Stint lifecycle"},
			{name: "--ninfer-deployment", argument: "<source-build|release-bundle>", purpose: "new-session NInfer deployment"},
			{name: "--ninfer-config", argument: "<coding|precision|native>", purpose: "new-session NInfer configuration"},
